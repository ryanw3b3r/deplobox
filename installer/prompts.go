...
func PromptForMissingValues(c *Config) error {
	...
	if c.OwnerRepo == "" {
		...
		fmt.Println("Example: username/my-app")
	...
	if c.WebhookURL == "" {
		...
		fmt.Println("Example: https://server.example.com")
	...
	if c.ProjectDomain == "" {
		...
		fmt.Println("Example: myapp.example.com")
	...
	if c.DeploboxHome == "" {
		...
		fmt.Println("Example: /home/deploybot/deplobox")
		c.DeploboxHome = readValue(reader, "Enter deplobox home", "/home/deploybot/deplobox")
	}
